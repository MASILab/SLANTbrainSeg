...
def fcdensenet_tiny(**kwargs):
    return FCDenseNet(2, 6, drop_rate=0, **kwargs)


def fcdensenet56_nodrop(**kwargs):
    return FCDenseNet(4, 12, drop_rate=0, **kwargs)


def fcdensenet56(**kwargs):
    return FCDenseNet(4, 12, drop_rate=0.2,**kwargs)


def fcdensenet67(**kwargs):
    return FCDenseNet(5, 16, drop_rate=0.2,**kwargs)


def fcdensenet103(**kwargs):
    return FCDenseNet([4, 5, 7, 10, 12, 15, 12, 10, 7, 5, 4], 16,
                      drop_rate=0.2,**kwargs)


def fcdensenet103_nodrop(**kwargs):
    return FCDenseNet([4, 5, 7, 10, 12, 15, 12, 10, 7, 5, 4], 16,
drop_rate=0,**kwargs)